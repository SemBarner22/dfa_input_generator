...
//        length = abs(((int) mt()) % ((int) (2.25 * m))) + 1.75 * m;
//        length = abs(((int) mt()) % ((int) (2.5 * m))) + 1.5 * m;
//        length = abs(((int) mt()) % ((int) (2.75 * m))) + 1.75 * m;
        length = abs(((int) mt()) % ((int) (1.5 * m))) + m;
        row.resize(length);
